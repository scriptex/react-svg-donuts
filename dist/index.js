...
var renderProgress = function renderProgress(progress) {
  return /*#__PURE__*/_react["default"].createElement("strong", null, progress);
};
...
var Donut = function Donut(_ref) {
  ...
  }, circleProps)), /*#__PURE__*/_react["default"].createElement("circle", _extends({
    className: getClassName(prefix, '__circle'),
    strokeDasharray: "".concat(Math.abs(progress), " 100")
  }, circleProps))), typeof onRender === 'function' && /*#__PURE__*/_react["default"].createElement("div", {
